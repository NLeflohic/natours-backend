      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.post('http://localhost:3000/api/v1/users/signin', {
              email: email,
              password: password
            });
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.data.status === 'Success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " updated successfull"));
              window.setTimeout(function () {
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoidmlra2luZyIsImEiOiJja2Q0a3dxMGsxOWt3MzFudHg5NXh4ajlsIn0.kHIzA-G2_ok0Gw928-9g4g';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/vikking/ckd4l1ycl052u1io7a3ics1vc',
    scrollZoom: false // center: [-122.148846, 37.761235],
    // zoom: 9,
    // interactive: false,
...
var stripe = Stripe('pk_test_51HAXDwDYrRXvZ8mLMTXsRZjvSUnPlbI0G8VTKk68vsqDxdRF6CtquiGFBvgLpyyRzWehotoibdWsehRa2tiq4dqE00zKZqX1NU');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //Create a checkout form + process (charge credit card)
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              tourID = e.target.dataset.tourId; //tour-id => tourId
